...
def main(message):
	...
	bot.send_photo(message.from_user.id,open('https://pp.userapi.com/c846323/v846323497/41715/HP8XApGfBS8.jpg','rb'))
...
def inlin(c):
	...
	if c.data=="right":
		...
		bot.send_photo(c.message.chat.id, open("C:/Users/ADMIN/Desktop/my_bot/bot/for_bot/Photo.PNG",'rb'))
